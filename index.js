// index.js — TEZLIK VA BARQARORLIK UCHUN OPTIMALLASHTIRILGAN + ANIMATSIYA (typing...)
...
app.post("/webhook", async (req, res) => {
  ...
  try {
    ...
    if (body.callback_query) {
      ...
      await sendTyping(chatId); // 🔹 animatsiya qo‘shildi
    ...
    if (["/zal", "/bass", "/8d"].includes(text)) {
      ...
      await sendTyping(chatId); // 🔹 typing animatsiyasi
...
// 🔹 typing animatsiya uchun funksiya
async function sendTyping(chatId) {
  try {
    ...
    console.warn("Typing animatsiya yuborilmadi:", e.message);
  }
}
